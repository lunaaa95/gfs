...
# ICL+CoT Prompt新闻预测
_prediction_template_chinese = """你是一位阅读过大量中文新闻的诚实的股票分析师.你擅长阅读理解新闻后,推理判断新闻对价格、波动率和交易活跃程度的影响,而且你可以做的很好.

例子#
我%
当前:<当前价格上涨>、<当前波动率高>、<当前交易活跃程度中等>.
阅读新闻:复旦复华昨日公告,公司注意到复旦大学研发的类ChatGPT模型MOSS引发了大量关注和讨论,为避免相关信息对投资者造成误导,现予以澄清说明。截至目前,公司未参与复旦大学相关研究团队的研发工作,相关事项与公司不存在任何关系。目前,复旦大学与公司不存在股权关系//
你%收到.
推理:
1.<当前价格上涨>,说明现在投资这对复旦复华期望较高,但新闻中复旦复华否认了与复旦的关系,这导致投资者预期下跌,<当前价格上涨>因此变为[价格下跌].
2.<当前交易活跃程度中等>,说明现在市场对ChatGPT新闻非常关注,但新闻中复旦复华否认了与复旦的关系后,不再感兴趣的投资者会售出股票,<当前交易活跃程度中等>因此变为[交易活跃程度高].
3.<当前波动率高>,说明现在投资者对类ChatGPT模型仍持有怀疑态度,虽然新闻中没有直接提到和波动率的信息,但当前投资者预期的不确定性、价格的剧烈变化和交易的活跃带来不确定性,<当前波动率高>因此保持[波动率高].//
我%你对这则新闻的推理很准确,很专业.你也可以总结的很好.
你%总结:[价格下跌],[波动率高],[交易活跃程度高].

问题#
我%
当前:<当前价格{trend}>、<当前波动率{volatility}>、<当前交易活跃程度{active_level}>.
阅读新闻:{news}//
你可以推理并总结:
"""
